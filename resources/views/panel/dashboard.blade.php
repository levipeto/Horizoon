 {{-- Overview --}}
 <div class="w-full p-8 adaptable:p-2 pb-20 adaptable:pb-28 overflow-hidden">
    <div class="text-3xl font-bold text-gray-800 adaptable:mt-4 adaptable:text-center">Dashboard Overview</div>
...
<div class="block pl-4 mt-12 w-full adaptable:bg-white bg-white rounded-sm shadow-2xl p-2">
    ...
    <div class="float-right pr-6 pt-3">
      ...
      <a class="shadow-sm lg:hidden large:hidden 2xl:hidden xl:hidden md:hidden" href="{{ route('add.product')}}">
