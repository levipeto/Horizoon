...
<div class="max-w-5xl adaptable:w-full adaptable:h-screen adaptable:mt-44 mx-auto mt-36 p-2 overflow-hidden adaptable:overflow-hidden
mobile:overflow-hidden adaptable:overflow-y-scroll
